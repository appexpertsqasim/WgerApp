...
public class ApiConstants {
    ...
    public static final String HEADER_AUTHORIZATION = "Authorization: Token e543e9dde58ab7551b2e27e5b36216603dc01b82";

    //public static final String APIKEY= "Authorization: Basic AIzaSyAy_SaniMHSArfLeRHvt6EeZ_hQNqI52oU";

    //Query
    public static final String QUERY = "maps/api/place/nearbysearch/json";
