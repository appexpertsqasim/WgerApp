...
public class WorkoutFragmentTest {
    @Rule
    public FragmentTestRule<WorkoutFragment> workoutFragmentTestRule = new FragmentTestRule<>(WorkoutFragment.class);

    @Before
    public void setUp() throws Exception{
        workoutFragmentTestRule.launchActivity(null);
    }
    ...
    @Test
    public void testButtonExistOnScreen(){
        onView(withId(R.id.workout_btn)).check(matches(isDisplayed()));
        onView(withId(R.id.workout_btn)).perform(click());
    }
